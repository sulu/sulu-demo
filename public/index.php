...
if (preg_match('/^\/my-custom-admin(\/|$)/', $_SERVER['REQUEST_URI'])) {
...
//    // only needed for symfony http cache
//    // demo uses varnish in prod so not required to have this if activated
